...
### 퍼널 형태의 특이성 (역모래시계형)
- 일반적인 이커머스 퍼널(방문→클릭→구매)은 하단으로 갈수록 좁아지는 깔때기 형태를 띠나,<br>본 분석은 '누적 구매 횟수' 기반으로 퍼널을 정의하였다. <br>이에 따라 신규 유입보다 기존 충성 고객의 축적량이 많을 경우, <br>퍼널 하단이 다시 넓어지는 '역모래시계형' 구조가 나타났다.
...
- Second → Regular: **107.31%**  --누적 거주 인원 기반의 상대적 비중
...
- 신규 고객 확보에만 의존하는 것이 아니라, 기존 고객 유지(Retention) 능력이 뛰어난 건강한 구조임을 시사
